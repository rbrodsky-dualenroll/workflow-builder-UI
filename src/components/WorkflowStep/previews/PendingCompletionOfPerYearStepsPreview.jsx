...
/**
 * Preview for PendingCompletionOfPerYearSteps steps
 */
const PendingCompletionOfPerYearStepsPreview = ({ step }) => {
  return (
    <div className="workflow-step-preview bg-white rounded border border-gray-200">
      <div className="p-4">
        <h3 className="text-lg font-bold mb-3">{step.role}: {step.title || 'Pending Completion of Per-Year Steps'}</h3>
        ...
        <div className="border border-dashed border-gray-300 rounded-md p-5 mb-4">
          ...
          <div className="bg-gray-50 border border-gray-300 rounded-md p-4 mb-4">
            <h4 className="font-medium mb-2">Waiting for Per-Year Steps</h4>
            <p className="text-sm text-gray-700">
              The system will verify that all per-year steps have been completed before proceeding.
            </p>
...
export default PendingCompletionOfPerYearStepsPreview;
